/*
  FarmBot Modular Power System Test Firmware for 35AHr AGM Battery
  Version xC 2/28/20
  This firmware works in conjunction with the PLX-DAQ
  Rev A: RGB LEDs, Temp Sensors, AGM Battery Charging, EEPROM, Over Temp ALERT and protection
  Rev B adds: EEPROM full warning and overrun protection, forces LTC4015 measurement system on when Vin is absent, 
    Q_COUNT, BSR
  Rev C: fixes the mother module light logic, adds hibernate function
*/
